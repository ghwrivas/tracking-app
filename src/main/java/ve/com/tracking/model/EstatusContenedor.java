...
@Entity
@Table(name = "estatus_contenedor")
@RooJavaBean
@RooJpaEntity(versionField = "", table = "estatus_contenedor")
@RooDbManaged(automaticallyDelete = true)
@RooToString(excludeFields = { "contenedorId", "usersId" })
public class EstatusContenedor implements Serializable {
    ...
    public String toString() {
        return new ReflectionToStringBuilder(this, ToStringStyle.SHORT_PREFIX_STYLE).setExcludeFieldNames("contenedorId", "usersId").toString();
    }
}
